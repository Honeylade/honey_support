...
def sync_product(p):
    ...
    if existing:
        # Existing product found, update it
        ...
        # No existing product found, do not create
        print(f"⚠️ No existing product found for: {product_payload['title']}. Skipping creation.")
