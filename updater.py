...
from xml.etree.ElementTree import ParseError  # Add this line at the top of your script
import re
...
def build_product(p):
    ...
    tags = (
        ...
        split_tags(p.get("productrange")) +  # Split product range into tags
        TAGS_TO_INCLUDE +
        sanitize_title(title)  # Use the new function to sanitize and split the title
    )
